...
import { installNewExerciseAck } from './new-exercise-ack.js';
...
// 暫時性 New Exercise ACK：把 build / click / API / fetch 階段直接顯示在畫面底部，
// 用來定位「連續新增第二個動作」卡住的真正位置。問題確認後可移除。
installNewExerciseAck(app);
